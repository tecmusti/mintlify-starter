---
title: "Authenticate with the estudjo API"
sidebarTitle: "Authentication"
description: "estudjo uses API keys passed in the X-Api-Key header. Learn how to create, list, and rotate your API keys for secure integration."
---
