...
<Warning>
  If your balance is too low to cover the cost of a generation, `POST /generate` returns a **402** response with the error code `insufficient_credits`. Top up your wallet via the [estudjo dashboard](https://estudjo.com/dashboard) before retrying.
</Warning>
