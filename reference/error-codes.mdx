---
title: "estudjo API Error Codes: Full Reference and Handling"
sidebarTitle: "Error Codes"
description: "Full reference for every estudjo API error code, its HTTP status, what triggers it, and the correct recovery strategy for each failure in your integration."
---
...
const res = await fetch('https://api.estudjo.com/generate', {
  method: 'POST',
  headers: {
